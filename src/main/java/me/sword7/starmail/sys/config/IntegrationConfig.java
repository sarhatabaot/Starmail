...
public class IntegrationConfig {
    ...
    private static final File file = new File("plugins/StarMail", "integrations.yml");
    private static final FileConfiguration config = YamlConfiguration.loadConfiguration(file);

    private static final String useDynmapString = "Enable Dynmap";
    private static boolean useDynmap = true;

    private static final String showPlotsMarkersByDefaultString = "Show Markers by Default";
    private static boolean showPlotMarkersByDefault = true;

    private static final String boxMinZoomString = "Mailbox Min Zoom";
    private static int boxMinZoom = 4;

    private static final String boxMaxZoomString = "Mailbox Max Zoom";
    private static int boxMaxZoom = -1;

    private static final String globalBoxMinZoomString = "Global Mailbox Min Zoom";
    private static int globalBoxMinZoom = -1;

    private static final String globalBoxMaxZoomString = "Global Mailbox Max Zoom";
    private static int globalBoxMaxZoom = -1;

    private static final String postboxMinZoomString = "Postbox Min Zoom";
    private static int postboxMinZoom = -1;

    private static final String postboxMaxZoomString = "Postbox Max Zoom";
