...
public class FMailbox implements IInsertable {
    ...
    public Inventory populate(Inventory menu, SessionData sessionData) {
        ...
        ItemStack base = box.getGlass().parseItem();
        ItemStack highlight = box.getHighlight().parseItem();
        ItemStack flag = box.getFlag().parseItem();
        ItemStack voidStack = XMaterial.BLACK_STAINED_GLASS_PANE.parseItem();
    ...
    private final ImmutableList<Integer> baseSlots = new ImmutableList.Builder<Integer>()
            .add(0, 1, 7, 9, 18, 35, 36, 44, 45, 53)
            .build();

    private final ImmutableList<Integer> voidSlots = new ImmutableList.Builder<Integer>()
    ...
    private final ImmutableList<Integer> highlightSlots = new ImmutableList.Builder<Integer>()
            .add(2).add(3).add(4).add(5).add(6).add(10).add(11).add(15).add(16)
            .add(19).add(25).add(34).add(37).add(43).add(46).add(52).build();


    private final ImmutableList<Integer> flagSlots = new ImmutableList.Builder<Integer>()
            .add(17).add(26).build();
    ...
    private final List<Integer> insertable = Collections.singletonList(27);
